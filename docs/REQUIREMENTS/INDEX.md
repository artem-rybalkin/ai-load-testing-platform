...
- FR-3.5 [MUST] System SHALL stream live metrics (response time, error rate, throughput) during k6 execution at an admin-configurable aggregation window (10s/30s/1min, default 30s; changes apply to new tests only)
